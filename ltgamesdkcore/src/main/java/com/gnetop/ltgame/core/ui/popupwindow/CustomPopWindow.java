package com.gnetop.ltgame.core.ui.popupwindow;
...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    public void update(int x, int y, int width, int height, boolean force) {
        ...
        if (mPopupWindow != null && mPopupWindow.isShowing()) {
            mPopupWindow.update(x, y, width, height, force);
        }
    }
    ...
    public boolean isShowing() {
        return (null != mPopupWindow) ? mPopupWindow.isShowing() : false;
    }
    ...
    private class RootView extends LinearLayout {
        ...
        protected void onConfigurationChanged(Configuration newConfig) {
            if (mPopupWindow != null && mPopupWindow.isShowing()) {//方向改变，pop消失
                mPopupWindow.dismiss();
            }
